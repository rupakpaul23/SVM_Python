#Erroneous Mapping for 16-QAM (Imbalanced Data) in Symbol Mapper
import pandas as pd
import numpy as np
...
df1= pd.concat([df, new_df], ignore_index=True) #trained data
print('org+anom\n',df1)
y=np.repeat([0,1], [16,240]) #trained label
#print('y1\n',y1)
